...
/**
 * This class represents a path generated from the summary graph, which starts from a matched node. 
...
public class SearchPath implements Comparable<SearchPath> {
	...
	public SearchPath(IndexedEdge edge, double prob) {
		vertices = new short[2];
